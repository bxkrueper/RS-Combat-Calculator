...
public class Monster implements MonsterInterface{
    ...
    public Monster(String name, String pictureName, String wikiLink, MonsterStats stats,Attacks attacks,MonsterAffinityWeaknesses affinityWeaknesses,Vulnerabilities vulnerabilities,Buff naturalBuffs){
        this.name = name;
